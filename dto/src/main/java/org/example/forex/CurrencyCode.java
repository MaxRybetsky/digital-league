...
public enum CurrencyCode {
    ...
    BSD("Bahamian Dollar"), BTC("Bitcoin"), BTN("Bhutanese Ngultrum"), BWP("Botswanan Pula"),
    BYN("New Belarusian Ruble"), BYR("Belarusian Ruble"), BZD("Belize Dollar"), CAD("Canadian Dollar"),
    CDF("Congolese Franc"), CHF("Swiss Franc"), CLF("Chilean Unit of Account (UF)"), CLP("Chilean Peso"),
    CNY("Chinese Yuan"), COP("Colombian Peso"), CRC("Costa Rican Colon"), CUC("Cuban Convertible Peso"),
    ...
    MNT("Mongolian Tugrik"), MOP("Macanese Pataca"), MRO("Mauritanian Ouguiya"), MUR("Mauritian Rupee"),
    MVR("Maldivian Rufiyaa"), MWK("Malawian Kwacha"), MXN("Mexican Peso"), MYR("Malaysian Ringgit"),
    MZN("Mozambican Metical"), NAD("Namibian Dollar"), NGN("Nigerian Naira"), NIO("Nicaraguan Cardoba"),
    ...
    SOS("Somali Shilling"), SRD("Surinamese Dollar"), STD("Sao Tome and Principe Dobra"), SVC("Salvadoran Colon"),
    SYP("Syrian Pound"), SZL("Swazi Lilangeni"), THB("Thai Baht"), TJS("Tajikistani Somoni"),
    TMT("Turkmenistani Manat"), TND("Tunisian Dinar"), TOP("Tongan Pananga"), TRY("Turkish Lira"),
    TTD("Trinidad and Tobago Dollar"), TWD("New Taiwan Dollar"), TZS("Tanzanian Shilling"), UAH("Ukrainian Hryvnia"),
    UGX("Ugandan Shilling"), USD("United States Dollar"), UYU("Uruguayan Peso"), UZS("Uzbekistan Som"),
    VEF("Venezuelan Bolivar Fuerte"), VND("Vietnamese Dong"), VUV("Vanuatu Vatu"), WST("Samoan Tala"),
    XAF("CFA Franc BEAC"), XAG("Silver (troy ounce)"), XAU("Gold (troy ounce)"), XCD("East Caribbean Dollar"),
    XDR("Special Drawing Rights"), XOF("CFA Franc BCEAO"), XPF("CFP Franc"), YER("Yemeni Rial"),
